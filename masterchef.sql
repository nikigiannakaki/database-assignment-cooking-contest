...
CREATE DATABASE `cooking` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `masterchef`;
...
BEGIN
    ...
    WHILE j < 10 DO
	   ...
	   SELECT frst INTO cook_win FROM (SELECT co.cook_id AS frst, SUM(g.grade) AS total_score, co.priority
	    ...
	    INSERT INTO episodes (episode_id, season, number_of_episode,winner)
	    VALUES (ep_id, season_num, num_of_episode, cook_win); 
END//
DELIMITER ;
